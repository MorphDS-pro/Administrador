...
btnSave.addEventListener('click', async (e) => {
    ...
    // Obtén el nombre de la empresa (usando el texto del <option> seleccionado)
    const companyName = registerCompany.options[registerCompany.selectedIndex].text.trim(); // Usamos .text para obtener el nombre
    ...
    try {
        ...
        // Aquí registramos el nombre de la empresa en lugar del ID
        const dataToSend = {
            id: idIncremental,
            nombre: companyName,  // Registramos el nombre de la empresa
        ...
        console.log(dataToSend); // Imprime los datos a la consola para depuración

        // Guardamos el nuevo contacto en Firestore

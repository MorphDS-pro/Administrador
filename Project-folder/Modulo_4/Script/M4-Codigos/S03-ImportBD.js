...
btnImportar.addEventListener('click', async () => {
    ...
    try {
        ...
        for (const row of rows) {
            ...
            console.log('Preparando datos para guardar en Firebase:', { id: newId, empresa, rut, usuario });
            ...
            try {
                ...
                console.log('Datos guardados correctamente:', { id: newId, empresa, rut, usuario });
            } catch (error) {
...
// Escuchar cambios en la colección de empresas
...
function renderTable(empresas) {
    ...
    empresas.forEach(empresa => {
        ...
        let fecha;
        if (empresa.fecha instanceof Timestamp) {
            fecha = empresa.fecha.toDate().toLocaleDateString('es-CL');
        } else if (typeof empresa.fecha === 'string') {
            // Intentar formatear cadenas de fecha
            fecha = new Date(empresa.fecha).toLocaleDateString('es-CL');
        } else {
